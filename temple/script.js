...
if (timeline) {
  ...
  let i = 0;
  let i2 = 1;
  let target1 = timeline.querySelector("ul");
  let target2 = timeline.querySelectorAll("ul li");

  function showTime(e) {
    e.setAttribute("done", "true");
    e.querySelector(".timeline-icon").style.background = "orange";
  ...
  function hideTime(e) {
    ...
    e.querySelector(".timeline-icon").style.background = "rgb(228, 228, 228)";
